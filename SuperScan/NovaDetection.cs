...
namespace SuperScan
{
    class NovaDetection
    {
        ...
        public void Detect(string gname, double subFrameSizeInArcSec, double gRA, double gDec, string freshImagePath, string storedImagePath, string workingImageFolder)
        {
